...
int main() {
  ...
  // Test valid access
  if (safe_array_access(arr, 5, 2) != 3)
    return 1;

  // Test out of bounds access
  if (safe_array_access(arr, 5, 10) != -1)
    return 1;
  if (safe_array_access(arr, 5, -1) != -1)
    return 1;
  ...
  if (!validate_input(5, 1, 10))
    return 1;
  if (validate_input(0, 1, 10))
    return 1;
  if (validate_input(15, 1, 10))
    return 1;
