...
#define safe_unary_minus_func_int8_t_s(si, _si)                                \
  ((int8_t)(si = (_si), (((int8_t)(si)) == (INT8_MIN)) ? ((int8_t)(si))        \
                                                       : (-((int8_t)(si)))))
...
#define safe_unary_minus_func_int16_t_s(si, _si)                               \
  ((int16_t)(si = (_si), (((int16_t)(si)) == (INT16_MIN))                      \
                             ? ((int16_t)(si))                                 \
                             : (-((int16_t)(si)))))
...
#define safe_unary_minus_func_int32_t_s(si, _si)                               \
  ((int32_t)(si = (_si), (((int32_t)(si)) == (INT32_MIN))                      \
                             ? ((int32_t)(si))                                 \
                             : (-((int32_t)(si)))))
...
#define safe_unary_minus_func_int64_t_s(si, _si)                               \
  ((int64_t)(si = (_si), (((int64_t)(si)) == (INT64_MIN))                      \
                             ? ((int64_t)(si))                                 \
                             : (-((int64_t)(si)))))
...
#define safe_mul_func_uint64_t_u_u(ui1, _ui1, ui2, _ui2)                       \
  ((uint64_t)((                                                                \
      ui1 = (_ui1), ui2 = (_ui2),                                              \
      (uint64_t)(((unsigned long long)(ui1)) * ((unsigned long long)(ui2))))))
