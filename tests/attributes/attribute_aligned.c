...
int main() {
    ...
    if (aligned.a != 'A') return 1;
    if (aligned.b != 42) return 1;
    if (aligned.c != 'B') return 1;
    
    if (aligned16.a != 'X') return 1;
    if (aligned16.b < 3.13 || aligned16.b > 3.15) return 1;
    if (aligned16.c != 100) return 1;
