...
int main() {
    ...
    if (result1 != 17) return 1;  // (3*4) + (10-5) = 12 + 5 = 17
    
    int result2 = multiply(add(2, 3), subtract(8, 3));
    if (result2 != 25) return 1;  // (2+3) * (8-3) = 5 * 5 = 25
    
    int result3 = complex_calculation(2, 3, 10);
    if (result3 != 11) return 1;  // (2*3) + (10-5) = 6 + 5 = 11
    
    int result4 = nested_expression(4, 5, 10);
    if (result4 != 25) return 1;  // (4*5) + (10/2) = 20 + 5 = 25
